...
// DATA
let yourName = (localStorage.getItem('yourName') != null)? localStorage.getItem('yourName') : 'Chiku';
yourNameInput.value = yourName;
let herName = (localStorage.getItem('herName') != null)? localStorage.getItem('herName') : 'Darlings';
...
function assignData(yourName, herName) {
    data = [
        {
            title       :   'Introduction',
            questions   :   ['hi darling', 'hello', 'hey', 'whatsup'],
            ...
            ans         :   ['hello sir','hello sir  Good Morning', 'What can i help you sir']
        },
        {
            title       :   'Propose',
        ...
        },
        {
            ...
            ans         :   ['Sangram', 'Chiku', 'Sangram Sahoo']
        },
        {
            title       :   'Family',
            questions   :   ['your family'],
            ans         :   ['Saroj Sahoo and Mitali Sahoo']
        }
    ]
}
...
function readData(message) {
    ...
    message = (message == false)? "Sorry" : message;
